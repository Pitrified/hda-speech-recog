...
learning rate covers the optimal range of values found by sweeping. A small
increase in loss corresponds to the peak of the second cycle. Finally with the
last two cycles the model converges.
