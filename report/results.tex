...
\tab{tab:mega_comparison} shows the results for all architectures and
tasks, listing the F-Score mean, standard deviation and max values.
% TODO:
...
Some confusion matrices are shown in
\fig{fig:VAN_opa1_lr03_bs32_en14_dsaug14_wyn_cm}
...
\fig{fig:VAN_opa1_lr03_bs32_en15_dsaug14_wLTBnum_cm}
...
\fig{fig:VAN_opa1_lr03_bs32_en15_dsmel04_wLTBall_noval_cm}
...
\fig{fig:SI2_opa1_lr04_bs32_en15_dsmel04_wLTBall_noval_cm}
