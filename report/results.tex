...
TODO: move this in single section and aggregate by CNN/LSTM+attention
because CNN performed a lot better with augmented.

As explained in \secref{sec:data_augmentation}, several types of augmentation
were performed on the dataset. The bulk of the investigation was to 
determine which kind of augmentation performed better.

Only barely outperformed the dataset mel04
...
\begin{table}[ht!]
    ...
    \begin{tabular}{|cc|c|}
        ...
        % mela1   &  0.958 & 0.0155 \\
        \hline
        02,03,04,05 & mel\_02+big &  $0.929 \pm 0.0362$ \\
        06,07,08,09 & mel\_01+big &  $0.939 \pm 0.0392$ \\
        10,11,12,13 & mel\_03+big &  $0.932 \pm 0.0852$ \\
        14,15,16,17 & mel\_03+small &  $0.964 \pm 0.0129$ \\
        \hline
    \end{tabular}
\end{table}
